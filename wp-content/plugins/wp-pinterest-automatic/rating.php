...
function wp_pinterest_automatic_rating_notice() {
	...
	if(trim($wp_deandev_rating) == ''){
		...
		if($count > 5 ){
		    ...
		    <div class="updated">
		        <p><?php echo 'Do you mind helping (<a href="http://deandev.com/me">DeanDev</a>) by rating  "Wordpress Pinterest Automatic" ? your good rating will <strong>help us improve</strong> the plugin <a style="text-decoration: underline;" href="http://codecanyon.net/downloads">Rate Now »</a> <a  style="float:right"  href="'.$uri.'">(x) </a> '; ?></p>
		    </div>
		    <?php

			...
			<div class="product-div">
				...
				<div style="padding:5px;margin:10px 0 10px 0;">
					<?php 
						...
						// echo $m[0];
					?>
					<!-- <a href="<?php echo($m[0]); ?>" target="_blank"><img src="/wp-content/themes/onecart/img/buy.png" width="224" height="54"></a> -->
					<a href="<?php echo($link); ?>" target="_blank"><img src="/wp-content/themes/onecart/img/buy.png" width="224" height="54"></a>
				</div>
